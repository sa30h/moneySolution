...
class PersonalInsurancepayment(models.Model):
...
class CarInsurancepayment(models.Model):
    provider=models.CharField(max_length=100)
    ammount=models.PositiveIntegerField()
    installment=models.CharField( max_length=50,choices=intallmentchoice)
    transaction_id=models.CharField(max_length=100)
...
class Houseinsurancepayment(models.Model):
    provider=models.CharField(max_length=100)
    ammount=models.PositiveIntegerField()
    installment=models.CharField( max_length=50,choices=intallmentchoice)
    transaction_id=models.CharField(max_length=100)
...
class TravelInsurancepayment(models.Model):
    provider=models.CharField(max_length=100)
    ammount=models.PositiveIntegerField()
    installment=models.CharField( max_length=50,choices=intallmentchoice)
    transaction_id=models.CharField(max_length=100)
